...
@HiltViewModel
class MainViewModel @Inject constructor(repository: MainRepository) :
    BaseViewModel<MainRepository>(repository) {

    private val retrieveWorkStudyListResponseInternal =
        MutableLiveData<ApiResource<List<Content>>>()
    ...
    private val retrieveSummarizeCategoryListResponseInternal =
        MutableLiveData<ApiResource<List<SummarizeData>>>()
